...
# 기능 명세: Storybook + shadcn/ui Component Ownership

**Feature Branch**: `01-storybook-shadcn-forms`  
**Created**: 2026-02-11  
**Status**: Draft (Restarted)  
...
- **SC-001**: `spec.md`, `plan.md`, `tasks.md`가 ownership 원칙(FR-001~FR-007)을 동일하게 참조한다.
